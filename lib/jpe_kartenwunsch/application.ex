defmodule JpeKartenwunsch.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: JpeKartenwunsch.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    JpeKartenwunschWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
